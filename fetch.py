#!/usr/bin/env python3
"""
Recuperation des codes promo Bulk depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/bulk.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/bulk.com"
STORE_NAME = "Bulk"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Bulk depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-bulk)"
    }
    try:
